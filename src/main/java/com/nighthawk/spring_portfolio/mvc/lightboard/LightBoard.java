...
public class LightBoard {
    ...
    public String toColorPalette() {
        ...
        public void turnOnLight(int row, int column) {
            System.out.println("Turning on light in position " + row + ", " + column);
                    lights[row][column].setOn(true);
        }
    
        public void turnOffLight(int row, int column) {
            System.out.println("Turning off light in position " + row + ", " + column);
                    lights[row][column].setOn(false);
        }
    ...
    static public void main(String[] args) {
        ...
        lightBoard.turnOffLight(2, 2);
        System.out.println(lightBoard.toColorPalette());

        lightBoard.turnOffLight(3, 4);
        System.out.println(lightBoard.toColorPalette());

        lightBoard.turnOffLight(4, 0);
        System.out.println(lightBoard.toColorPalette());

        lightBoard.turnOnLight(2, 2);
        System.out.println(lightBoard.toColorPalette());
